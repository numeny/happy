...
class GanjiSpider(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
             ...
             'https://esf.fang.com/chushou/3_437469611.htm',
    ...
    def parseCityToZone(self, response):
        '''
        '''
        new_urls = response.xpath('//div[@id="tuigangn"]/span[@id="mobilecode"]/text()').extract()
        logger.debug('parseCityToZone-1, body %s' % response.xpath('//body/text()').extract());
        logger.debug('parseCityToZone-1, body %s' % new_urls);
    '''
