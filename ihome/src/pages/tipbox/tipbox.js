...
const sPersonalIncomeInfo2 = '2. 其他情况，征收个人所得税。（原值输入为零，代表没有提供原值）'
        ...
        properties: {
          ...
          2: {title: '关于个人所得税',
              contents: [
                ...
                '   2) 有原值：个人所得税 =（网签价 - 本次增值税 - 原值 - 原税费合计）x 20%',
          ]},
          // ValueAddedTax
          3: {title: '关于增值税及附加',
              contents: [
          ...
          16: {title: '关于个人所得税',
              contents: [
                '本计算器按照下列方式计算个人所得税，如果不是此计算方法，请计算并手动输入个人所得税额。',
                sPersonalIncomeInfo,
                '2. 其他情况，征收个人所得税。个人所得税 = 网签价 x 0.01。',
          ]},
